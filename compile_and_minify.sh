...
cat {matching,scoring,adjacency_graphs,frequency_lists,init}.js  | function_wrap > zxcvbn.js
java -jar tools/closure.jar --compilation_level $COMPILATION_LEVEL --js zxcvbn.js --js_output_file zxcvbn.min.js
java -jar tools/closure.jar --compilation_level $COMPILATION_LEVEL --js async.js    --js_output_file zxcvbn-async.min.js
echo 'done. produced zxcvbn.min.js and zxcvbn-async.min.js'
